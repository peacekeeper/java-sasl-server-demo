...
public class SaslServerDemoCramMD5 extends SaslServerDemo {
    ...
    public SaslServerDemoCramMD5() {
        super(DEFAULT_MECHANISM, DEFAULT_PROTOCOL, DEFAULT_SERVER_NAME, DEFAULT_PROPS);
    }

    public static void main(String[] args) throws SaslException {
        SaslServer saslServer = new SaslServerDemoCramMD5().createSaslServer(new BackendIntegrationDemoUsername());
